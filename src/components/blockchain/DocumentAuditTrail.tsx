  ...
  return <Card className="shadow-sm">
      ...
      <CardContent className={`space-y-4 ${isMobile ? "px-4" : ""}`}>
        {isLoading ? <div className="flex justify-center py-8">
          ...
          </div> : blocks.length === 0 ? <div className="py-6 text-center text-muted-foreground">
            ...
            <div className="space-y-3 mt-4">
              ...
              <ul className="space-y-3">
                {blocks.map((block, index) => <li key={block.hash} className="relative pl-6 pb-3 border-l-2 border-gray-200 dark:border-gray-800">
